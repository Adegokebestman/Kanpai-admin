...
const PaymentProfile = () => {
  ...
  return (
    ...
    <div className="md:flex md:flex-col-3  justify-between items-center mx-4">
        ...
        <span className='hidden sm:block top-1/2 -right-[5%] translate-x-[20%] -translate-y-1/2 rounded-full bg-[#F0CFB6] text-[#A8591F] text-xs sm:text-sm relative py-1 px-2'>seller</span>
